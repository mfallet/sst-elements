...
Executable = "/home/aawad/SST_DEVE/BUILD_APPS/XSBench/src/XSBench"
#Executable = "/home/aawad/SST_DEVE/BUILD_APPS/TEST1_AMRO/TEST1"
clock = "2GHz"
memory_clock = "200MHz"
...
ariel.addParams({
    "launcher" : "/usr/local/module-pkgs/pin/pin-2.14-71313-gcc.4.4.7-linux//pin.sh",
    "arieltool" : "/home/aawad/SST_DEVE/sst-elements/src/sst/elements/ariel/fesimple.so",
    "verbose" : 1,
    "clock" : clock,
    "maxcorequeue" : 256,
    "maxissuepercycle" : 3,
...
sst.setStatisticOutputOptions( {
	"filepath"  : "STATS/stats-snb-ariel-dram-mmu_w4_1GB"+str(run_num) +".csv",
	"separator" : ", "
} )
